...
await guzzzleAPI.createPost("noah1", "BEER", "https://products3.imgix.drizly.com/ci-coors-light-315ea47b7c9c0280.jpeg?auto=format%2Ccompress&ch=Width%2CDPR&fm=jpg&q=20", [1, 2, 3], "1. beer", "drink the beer", "crisp, light beer");
await guzzzleAPI.likePost("noah", 0);
await guzzzleAPI.createPost("noah1", "red red wineee", "https://media.gq-magazine.co.uk/photos/5f479e8eeadd3a2aff8f3081/3:2/w_1620,h_1080,c_limit/20200827-wine-07.jpg", [1, 2, 3], "1. WINE", "drink wine, get drunk", "red mf wine MFer");
...
for (const pid of feed_pids) {
        //get post contents
        let post_object = await guzzzleAPI.readPost(pid);
